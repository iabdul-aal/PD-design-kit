...
\begin{table}[H]
\centering
\caption{Waveguide-integrated Ge-on-Si PIN photodetectors with vertical
junction architectures (V), benchmarked against the metrics of
\cref{sec:pd_concept}. ``NR'' denotes values not reported by the authors.
Bandwidth values are electrical $S_{21}$ or equivalent-circuit measurements
unless noted.}
...
Taken together, \cref{tab:pd_lit_vertical} reveals the optimisation philosophy for vertical junction designs. Vertical junction designs advance incrementally with layouts that remain closer to mainstream SOI foundry practice: their progression from \SI{42}{\giga\hertz} to \SI{103}{\giga\hertz} reflects steady reduction of $R_sC_j$ through electrode engineering rather than changes to absorber material, thickness, or doping profile. The present work follows that trajectory by retaining the vertical Ge-on-Si PIN stack and concentrating on geometry-driven parasitic reduction. Broader reviews of the design space are
provided by
...
The selected vertical Ge-on-Si PIN architecture is validated against the IEEE 802.3 400GBASE-DR4 standard, which specifies per-lane data rates of 100 Gb/s using PAM-4 modulation at 106.25 GBd, requiring receiver bandwidth of at least 50 GHz. The design achieves this through the combination of high-speed electrical parasitics reduction and optical absorption optimization.
...
\paragraph{Mask layout implementation in KLayout.}
...
electrical runner. This layout abstraction does not replace the
three-dimensional optical and electrical solvers; rather, it establishes that
the structure analysed in this chapter is associated with a concrete mask-level
realisation whose lateral dimensions and contact topology are consistent with
the simulated device. Design dimensions are shown in \cref{fig:design_dimensions}, and a top-view rendering derived from the same scripted
geometry is shown in \cref{fig:klayout_layout}.

\begin{figure}[H]
\centering
\caption{Design dimensions and specifications for the Ge-on-Si PIN photodetector device.}
...
\midrule
Ge thickness & \SI{350}{\nano\metre} \\
Ge width & \SI{5}{\micro\metre} \\
Ge length & \SI{8}{\micro\metre} \\
Intrinsic region width & \SI{3}{\micro\metre} \\
Taper length & \SI{40}{\micro\metre} \\
U-shaped contact width & \SI{1}{\micro\metre} \\
$n^{++}$ contact width & \SI{0.5}{\micro\metre} \\
Via pitch & \SI{0.5}{\micro\metre} \\
M1 thickness & \SI{0.5}{\micro\metre} \\
M2 thickness & \SI{2}{\micro\metre} \\
BOX thickness & \SI{2}{\micro\metre} \\
\bottomrule
\end{tabular}
\end{figure}
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[x=0.035cm,y=0.35cm,line join=round,line cap=round]
        \fill[gray!12] (-12,-6.5) rectangle (52,6.5);
        \fill[cyan!14] (-11,-5.5) rectangle (51,5.5);
        \fill[black!18] (-165,-1.0) rectangle (40,1.0);
        \fill[blue!35] (-10,-0.25) rectangle (0,0.25);
        \fill[blue!20] (0,-0.25) -- (0,0.25) -- (40,2.5) -- (40,-2.5) -- cycle;
        \fill[green!28] (40,-2.5) rectangle (48,2.5);
        \fill[red!28] (40,-3.5) rectangle (48,-2.5);
        \fill[red!28] (40,2.5) rectangle (48,3.5);
        \fill[red!28] (47.95,-2.5) rectangle (48,2.5);
        \fill[orange!35] (40.3,-2.2) rectangle (47.7,2.2);
        \fill[yellow!50!white] (40.3,-0.4) rectangle (47.7,0.4);
        \fill[yellow!50!white] (38.4,-3.5) rectangle (49.6,-2.7);
        \fill[yellow!50!white] (38.4,2.7) rectangle (49.6,3.5);
        \fill[yellow!50!white] (48.8,-3.5) rectangle (49.6,3.5);

        \foreach \x in {40.8,42.4,44.0,45.6,47.2} {
            \fill[white] (\x,-0.3) rectangle ++(0.6,0.6);
            \draw[black!40, line width=0.12pt] (\x,-0.3) rectangle ++(0.6,0.6);
        }
        \foreach \x/\y in {41.0/-3.2,44.0/-3.2,47.0/-3.2,41.0/2.6,44.0/2.6,47.0/2.6} {
            \fill[white] (\x,\y) rectangle ++(0.6,0.6);
            \draw[black!40, line width=0.12pt] (\x,\y) rectangle ++(0.6,0.6);
        }

        \draw[black!55, line width=0.2pt] (-12,-6.5) rectangle (52,6.5);
        \draw[black!55, line width=0.2pt] (-11,-5.5) rectangle (51,5.5);
        \draw[black!55, line width=0.2pt] (-165,-1.0) rectangle (40,1.0);
        \draw[black!55, line width=0.2pt] (-10,-0.25) rectangle (0,0.25);
        \draw[black!55, line width=0.2pt] (0,-0.25) -- (0,0.25) -- (40,2.5) -- (40,-2.5) -- cycle;
        \draw[black!55, line width=0.2pt] (40,-2.5) rectangle (48,2.5);
        \draw[black!55, line width=0.2pt] (40,-3.5) rectangle (48,-2.5);
        \draw[black!55, line width=0.2pt] (40,2.5) rectangle (48,3.5);
        \draw[black!55, line width=0.2pt] (47.95,-2.5) rectangle (48,2.5);
        \draw[black!55, line width=0.2pt] (40.3,-2.2) rectangle (47.7,2.2);
        \draw[black!55, line width=0.2pt] (40.3,-0.4) rectangle (47.7,0.4);
        \draw[black!55, line width=0.2pt] (38.4,-3.5) rectangle (49.6,-2.7);
        \draw[black!55, line width=0.2pt] (38.4,2.7) rectangle (49.6,3.5);
        \draw[black!55, line width=0.2pt] (48.8,-3.5) rectangle (49.6,3.5);

        \node[font=\scriptsize, anchor=east] at (-167, 0) {M2 runner};
        \draw[black!60, line width=0.2pt] (-165,0) -- (-170,0);
        \node[font=\scriptsize, anchor=south] at (-5,0.35) {Si input waveguide};
        \node[font=\scriptsize, anchor=south] at (20,2.9) {Adiabatic taper};
        \node[font=\scriptsize, anchor=west] at (51,3.15) {U-shaped M1 contact};
        \draw[black!60, line width=0.2pt] (49.2,3.1) -- (50.6,3.1);
        \node[font=\scriptsize, anchor=west] at (50.2,0) {Ge mesa and $n^{++}$ region};
        \draw[black!60, line width=0.2pt] (48,0) -- (49.8,0);
        \node[font=\scriptsize, anchor=west] at (50.2,-3.0) {Via array};
        \draw[black!60, line width=0.2pt] (47.3,-2.9) -- (49.8,-2.9);

        \draw[<->, black!70, line width=0.18pt] (0,-4.6) -- (40,-4.6);
        \node[font=\scriptsize, fill=white, inner sep=1pt] at (20,-4.6) {\SI{40}{\micro\metre}};
        \draw[<->, black!70, line width=0.18pt] (40,-4.6) -- (48,-4.6);
        \node[font=\scriptsize, fill=white, inner sep=1pt] at (44,-4.6) {\SI{8}{\micro\metre}};
        \draw[<->, black!70, line width=0.18pt] (50.8,-2.5) -- (50.8,2.5);
        \node[font=\scriptsize, fill=white, inner sep=1pt, rotate=90] at (50.8,0) {\SI{5}{\micro\metre}};

        \node[font=\scriptsize, anchor=west] at (-11,-7.8) {BOX};
        \fill[gray!12] (-18,-8.15) rectangle (-13.6,-7.45);
        \draw[black!55, line width=0.18pt] (-18,-8.15) rectangle (-13.6,-7.45);
        \node[font=\scriptsize, anchor=west] at (-0.5,-7.8) {Si slab};
        \fill[cyan!14] (-7,-8.15) rectangle (-2.6,-7.45);
        \draw[black!55, line width=0.18pt] (-7,-8.15) rectangle (-2.6,-7.45);
        \node[font=\scriptsize, anchor=west] at (10,-7.8) {Si ridge and taper};
        \fill[blue!35] (0.2,-8.15) rectangle (4.6,-7.45);
        \draw[black!55, line width=0.18pt] (0.2,-8.15) rectangle (4.6,-7.45);
        \node[font=\scriptsize, anchor=west] at (35,-7.8) {Ge};
        \fill[green!28] (31.3,-8.15) rectangle (35.7,-7.45);
        \draw[black!55, line width=0.18pt] (31.3,-8.15) rectangle (35.7,-7.45);
        \node[font=\scriptsize, anchor=west] at (49,-7.8) {$p^{++}$};
        \fill[red!28] (44.8,-8.15) rectangle (49.2,-7.45);
        \draw[black!55, line width=0.18pt] (44.8,-8.15) rectangle (49.2,-7.45);
        \node[font=\scriptsize, anchor=west] at (62,-7.8) {$n^{++}$};
        \fill[orange!35] (57.6,-8.15) rectangle (62,-7.45);
        \draw[black!55, line width=0.18pt] (57.6,-8.15) rectangle (62,-7.45);
        \node[font=\scriptsize, anchor=west] at (76,-7.8) {Via};
        \fill[white] (71.2,-8.15) rectangle (75.6,-7.45);
        \draw[black!55, line width=0.18pt] (71.2,-8.15) rectangle (75.6,-7.45);
        \node[font=\scriptsize, anchor=west] at (88,-7.8) {M1};
        \fill[yellow!50!white] (84.4,-8.15) rectangle (88.8,-7.45);
        \draw[black!55, line width=0.18pt] (84.4,-8.15) rectangle (88.8,-7.45);
        \node[font=\scriptsize, anchor=west] at (100,-7.8) {M2};
        \fill[black!18] (96.1,-8.15) rectangle (100.5,-7.45);
        \draw[black!55, line width=0.18pt] (96.1,-8.15) rectangle (100.5,-7.45);
    \end{tikzpicture}
    \caption{KLayout realisation of the photodetector mask corresponding to the
    simulated O-band device. The top-view layout preserves the taper-coupled
    optical path, the U-shaped contact topology, and the electrical routing
    geometry used to define the mask-level implementation.}
...
As a brief external consistency check, the extracted device metrics remain
compatible with the receiver-side bandwidth target of IEEE~802.3
400GBASE-DR4~\cite{IEEE80232022}, since the simulated response exceeds the
\SI{39.8}{\giga\hertz} threshold by a comfortable margin. The more restrictive
device-level constraint is instead the field-screening limit
$P_{\mathrm{screening}}\approx\SI{340}{\micro\watt}$ from \cref{eq:p_screening},
which indicates that optical power management would still be required at the
upper end of the receive-power window. This observation is retained only as a
final application check; it is not used as the organising framework of the
chapter.
...
then used a physically grounded architectural justification together with the
literature review to show why the waveguide-integrated Ge-on-Si PIN remains the correct
...
The detector-level sensitivity analysis derived
$P_{\mathrm{sens}}\approx\SI{-17.1}{\dBm}$ from \cref{eq:sens_full} and showed
that the simulated bandwidth remains compatible with the receiver-side target
of IEEE~802.3 400GBASE-DR4. The limiting constraint in that final application
check is not bandwidth, but the electric-field-screening onset of
\cref{eq:p_screening}, which remains below the highest receive-power condition.
