...
and the dark current floor through \cref{eq:jdark_srh}. The calibrated
$\tau_0=\SI{5}{\nano\second}$ used in the electrical simulation of
\cref{subsec:pd_charge} implicitly encodes this threading-dislocation density.
