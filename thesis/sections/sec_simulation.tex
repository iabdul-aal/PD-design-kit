...
\paragraph{FDTD source field and the Îµ''-based generation rate.}
...
Carrier transport is simulated in Lumerical DEVICE CHARGE under two-dimensional steady-state conditions, solving the PDE system of
...
neurons each, hyperbolic-tangent activations, and a two-dimensional spatial
